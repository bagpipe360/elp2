...
class IdentitiesControllerTest < ActionController::TestCase
  ...
  test "should create identity" do
    assert_difference('Identity.count') do
      post :create, identity: { email: @identity.email, password_digest: @identity.password_digest, user_id: @identity.user_id }
    end
  ...
  test "should update identity" do
    put :update, id: @identity, identity: { email: @identity.email, password_digest: @identity.password_digest, user_id: @identity.user_id }
    assert_redirected_to identity_path(assigns(:identity))
  end
