...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { application_id: @interview.application_id, date_completed: @interview.date_completed, interview_score: @interview.interview_score }
    end
  ...
  test "should update interview" do
    put :update, id: @interview, interview: { application_id: @interview.application_id, date_completed: @interview.date_completed, interview_score: @interview.interview_score }
    assert_redirected_to interview_path(assigns(:interview))
  end
