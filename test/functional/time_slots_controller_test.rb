...
class TimeSlotsControllerTest < ActionController::TestCase
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post :create, time_slot: { end_time: @time_slot.end_time, start_time: @time_slot.start_time, teacher_id: @time_slot.teacher_id }
    end
  ...
  test "should update time_slot" do
    put :update, id: @time_slot, time_slot: { end_time: @time_slot.end_time, start_time: @time_slot.start_time, teacher_id: @time_slot.teacher_id }
    assert_redirected_to time_slot_path(assigns(:time_slot))
  end
